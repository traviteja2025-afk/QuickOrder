...
const Header: React.FC<HeaderProps> = ({ currentView, setView, currentUser, onLogout, onLogin }) => {
  return (
    <header className="bg-white shadow-md sticky top-0 z-10">
      <div className="container mx-auto px-4 py-4 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setView('landing')} title="Back to Home">
