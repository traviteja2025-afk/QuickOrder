...
const Header: React.FC<HeaderProps> = ({ currentView, setView, currentUser, onLogout, onLogin, onLogoClick }) => {
  const handleHomeClick = onLogoClick || (() => setView('landing'));
      ...
      <div className="container mx-auto px-4 py-4 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
        ...
        <div className="flex items-center gap-4">
            ...
            <button 
                ...
                className="p-2 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50"
                title="Go to Home"
            >
            ...
            {/* Logo */}
            <div className="flex items-center space-x-3 cursor-pointer" onClick={handleHomeClick} title="Back to Home">
