...
const OrderForm: React.FC<OrderFormProps> = ({ products, onPlaceOrder, currentUser }) => {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                  <div className="flex justify-between items-center border-b pb-2">
                    ...
                    {currentUser && <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full font-medium">Logged in as {currentUser.name}</span>}
                  </div>
                  <div>
